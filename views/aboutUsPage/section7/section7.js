    ...
    return(
        <div className = {`${styles.container}`}>
            ...
            <div style = {{position: 'absolute', top: '150px', left: '-25rem'}}>
                <Image priority  src = '/../public/about_sec7_ellipse1.png' width = '450px' height = '400px'/>
            </div>

            <div style = {{position: 'absolute', bottom: '0', right: '-12rem'}}>
                <Image priority  src = '/../public/about_sec7_ellipse2.png' width = '270px' height = '400px'/>
            </div>

            <p data-aos-offset = {-1500*scroll} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.heading}`}>Advantages of Our Working With Borgfy  Venture Studio</p>
            <div className = 'hide_in_mobile' style = {{position: 'absolute', top: '489px', left: '48px'}}>
                <Image priority  src = '/../public/venture_advantages_path.png' width = '248px' height = '1520px'/>
            </div>
        
            <div className={styles.imCon} data-aos-offset = {-1600*scroll} data-aos = 'fade-up' data-aos-duration = '3000'>
            ...
            <div className={styles.imCon} data-aos-offset = {-1700*scroll} data-aos = 'fade-up' data-aos-duration = '3000'>
            ...
            <div className={styles.imCon} data-aos-offset = {-1800*scroll} data-aos = 'fade-up' data-aos-duration = '3000'>
            ...
            <div className={styles.imCon} data-aos-offset = {-1900*scroll} data-aos = 'fade-up' data-aos-duration = '3000'>
            ...
            <div className={styles.imCon} data-aos-offset = {-2000*scroll} data-aos = 'fade-up' data-aos-duration = '3000'>
            ...
            <div className={styles.imCon} data-aos-offset = {-2100*scroll} data-aos = 'fade-up' data-aos-duration = '3000'>
