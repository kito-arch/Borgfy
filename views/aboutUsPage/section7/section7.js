    ...
    return(
        <div className = {`${styles.container}`}>
            ...
            <div style = {{position: 'absolute', top: '150px', left: '-25rem'}}>
                <Image priority  src = './about_sec7_ellipse1.png' width = '450px' height = '400px'/>
            </div>

            <div style = {{position: 'absolute', bottom: '0', right: '-12rem'}}>
                <Image priority  src = './about_sec7_ellipse2.png' width = '270px' height = '400px'/>
            </div>

            <p data-aos-offset = {-1500*(screen.width <= 480 ? mobscroll : myscroll)} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.heading}`}>Advantages of Our Working With Borgfy  Venture Studio</p>
            ...
            <div className={styles.imCon} data-aos-offset = {-1600*(screen.width <= 480 ? mobscroll : myscroll)} data-aos = 'fade-up' data-aos-duration = '3000'>
            ...
            <div className={styles.imCon} data-aos-offset = {-1700*(screen.width <= 480 ? mobscroll : myscroll)} data-aos = 'fade-up' data-aos-duration = '3000'>
            ...
            <div className={styles.imCon} data-aos-offset = {-1800*(screen.width <= 480 ? mobscroll : myscroll)} data-aos = 'fade-up' data-aos-duration = '3000'>
            ...
            <div className={styles.imCon} data-aos-offset = {-1900*(screen.width <= 480 ? mobscroll : myscroll)} data-aos = 'fade-up' data-aos-duration = '3000'>
            ...
            <div className={styles.imCon} data-aos-offset = {-2000*(screen.width <= 480 ? mobscroll : myscroll)} data-aos = 'fade-up' data-aos-duration = '3000'>
            ...
            <div className={styles.imCon} data-aos-offset = {-2100*(screen.width <= 480 ? mobscroll : myscroll)} data-aos = 'fade-up' data-aos-duration = '3000'>
