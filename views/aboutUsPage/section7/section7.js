...
export default function Section7(props){
    return(
        <div className = {`${styles.container}`}>
            ...
            <p data-aos-offset = {-1500+scroll} data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.heading}`}>Advantages of Our Working With Borgfy  Venture Studio</p>
            <div style = {{position: 'absolute', top: '489px', left: '48px'}}>
                <Image src = './venture_advantages_path.png' width = '248px' height = '1520px'/>
            </div>
        
            <div data-aos-offset = {-1600+scroll} data-aos = 'fade-up' data-aos-duration = '1000'>
            ...
            <div data-aos-offset = {-1800+scroll} data-aos = 'fade-up' data-aos-duration = '1000'>
            ...
            <div data-aos-offset = {-1900+scroll} data-aos = 'fade-up' data-aos-duration = '1000'>
            ...
            <div data-aos-offset = {-2000+scroll} data-aos = 'fade-up' data-aos-duration = '1000'>
            ...
            <div data-aos-offset = {-2100+scroll} data-aos = 'fade-up' data-aos-duration = '1000'>
