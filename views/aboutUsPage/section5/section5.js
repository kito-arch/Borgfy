...
export default function Section5(props){
    return(
        <div className = {`${styles.container}`}>
            ...
            <p data-aos-offset = "-900" data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.heading}`}>Why we different from others</p>
            <p data-aos-offset = "-900" data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.text}`}>This revolutionary business model works on promoting or encouraging startups that have the potential to grow. Building an innovative business model from scratch is challenging. So, startups acquisition is favored under the venture studio model.<br/>Here is how it works. </p>

            <div style = {{marginBottom: '200px'}} className = {`${styles.centerCenter}`}>

                <div className = {`${styles.stretchBetween}`}>
                    <div data-aos-offset = "-1000" data-aos = 'fade-right' data-aos-duration = '1000' className = {`${styles.single}`}>
                    ...
                    <div data-aos-offset = "-1000" data-aos = 'fade-left' data-aos-duration = '1000' className = {`${styles.single}`}>
                        <Image src = '/../public/about_sec5_image2.png' width = '119px' height = '119px'/>
            ...
            <div className = {`${styles.centerCenter}`}>
                ...
                <div className = {`${styles.stretchBetween}`}>
                    <div data-aos-offset = "-1200" data-aos = 'fade-right' data-aos-duration = '1000' style = {{marginLeft: '-30px'}} className = {`${styles.single}`}>
                    ...
                    <div data-aos-offset = "-1200" data-aos = 'fade-left' data-aos-duration = '1000' style = {{paddingRight: '100px'}} className = {`${styles.single}`}>
