...
export default function Section5(props){
    return(
        <div data-aos-offset = {-scroll*800} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.container}`}>
            ...
            <div className = {`${styles.textContainer}`}>
                ...
                <div className = 'hide_in_mobile' style = {{marginTop: '-150px'}}>
                    <Image priority  src = '/../public/soch.png' width = '215.6px' height = '280px' />
                </div>
            </div>
