...
export default function Section2(props){
    return(
        <div className = {`${styles.container}`}>
            <div data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*300} data-aos = 'fade-up' data-aos-duration = '3000'>
            ...
            <p data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*300} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.text}`}>We thrive on experimenting with the latest UI/UX design and customer retention strategies.</p>
            <div className = {`${styles.cardContainer}`}>
                <div className={styles.caCon} data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*300} data-aos = 'fade-right' data-aos-duration = '3000' style = {{width: '21%'}}>
                ...
                <div className={styles.caCon} data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*300} data-aos = 'fade-left' data-aos-duration = '3000' style = {{width: '21%'}}>
