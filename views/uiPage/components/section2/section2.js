...
export default function Section2(props){
    return(
        <div className = {`${styles.container}`}>
            <div data-aos-offset = {scroll-300} data-aos = 'fade-up' data-aos-duration = '1000'>
                <Image src = './UX.png' width = '208px' height = '60px'/>
            </div>
            <p data-aos-offset = {scroll-300} data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.heading}`}>How Can We Help?</p>
            <p data-aos-offset = {scroll-300} data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.text}`}>We thrive on experimenting with the latest UI/UX design and customer retention strategies.</p>
            <div className = {`${styles.cardContainer}`}>
                <div data-aos-offset = {scroll-300} data-aos = 'fade-right' data-aos-duration = '1000' style = {{width: '21%'}}>
                ...
                <div data-aos-offset = {scroll-300} data-aos = 'fade-left' data-aos-duration = '1000' style = {{width: '21%'}}>
