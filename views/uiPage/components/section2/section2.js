    ...
    return(
        <div className = {`${styles.container}`}>
            ...
            <div className = {`${styles.cardContainer}`}>
                <div data-aos-offset = {-scroll*300} data-aos = 'fade-right' data-aos-duration = '3000' style = {{width: '21%'}}>
                ...
                <div data-aos-offset = {-scroll*300} data-aos = 'fade-left' data-aos-duration = '3000' style = {{width: '21%'}}>
