...
export default function Section5(props){
    return(
        <div className = {`${styles.container}`}>
            <p data-aos-offset = {-900*(screen.width <= 480 ? mobscroll : myscroll)} data-aos = 'fade-up' data-aos-duration = '3000' style = {{marginBottom: '30px'}} className = {`${styles.heading} ${styles.anHeading}`}>Development Phase</p>
            <p data-aos-offset = {-900*(screen.width <= 480 ? mobscroll : myscroll)} data-aos = 'fade-up' data-aos-duration = '3000' style = {{marginBottom: '156px'}} className = {`${styles.text}`}>
            ...
            <p data-aos-offset = {-900*(screen.width <= 480 ? mobscroll : myscroll)} data-aos = 'fade-up' data-aos-duration = '3000' style = {{margin: 'auto', marginBottom: '50px', width: 'fit-content'}} className = {`${styles.heading}`}>The development team includes the following professionals:</p>
            
            <div data-aos-offset = {-1000*(screen.width <= 480 ? mobscroll : myscroll)} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.innerContainer}`}>
            ...
            <div data-aos-offset = {-1100*(screen.width <= 480 ? mobscroll : myscroll)} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.innerContainer}`}>
            ...
            <div data-aos-offset = {-1200*(screen.width <= 480 ? mobscroll : myscroll)} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.innerContainer}`}>
            ...
            <div data-aos-offset = {-1300*(screen.width <= 480 ? mobscroll : myscroll)} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.innerContainer}`}>
            ...
            <div data-aos-offset = {-1400*(screen.width <= 480 ? mobscroll : myscroll)} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.innerContainer}`}>
            ...
            <div data-aos-offset = {-1500*(screen.width <= 480 ? mobscroll : myscroll)} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.innerContainer}`}>
