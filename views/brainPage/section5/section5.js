...
export default function Section5(props){
    return(
        <div className = {`${styles.container}`}>
            <p style = {{marginBottom: '30px'}} className = {`${styles.heading}`}>Development Phase</p>
            <p style = {{marginBottom: '156px'}} className = {`${styles.text}`}>
            ...
            <p style = {{margin: 'auto', marginBottom: '50px', width: 'fit-content'}} className = {`${styles.heading}`}>The development team includes the following professionals:</p>
