...
export default function Section5(props){
    return(
        <div className = {`${styles.container}`}>
            <p data-aos-offset = "-900" data-aos = 'fade-up' data-aos-duration = '1000' style = {{marginBottom: '30px'}} className = {`${styles.heading}`}>Development Phase</p>
            <p data-aos-offset = "-900" data-aos = 'fade-up' data-aos-duration = '1000' style = {{marginBottom: '156px'}} className = {`${styles.text}`}>
            ...
            <p data-aos-offset = "-900" data-aos = 'fade-up' data-aos-duration = '1000' style = {{margin: 'auto', marginBottom: '50px', width: 'fit-content'}} className = {`${styles.heading}`}>The development team includes the following professionals:</p>
            
            <div data-aos-offset = "-1000" data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.innerContainer}`}>
            ...
            <div data-aos-offset = "-1100" data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.innerContainer}`}>
            ...
            <div data-aos-offset = "-1200" data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.innerContainer}`}>
            ...
            <div data-aos-offset = "-1300" data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.innerContainer}`}>
            ...
            <div data-aos-offset = "-1400" data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.innerContainer}`}>
            ...
            <div data-aos-offset = "-1500" data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.innerContainer}`}>
