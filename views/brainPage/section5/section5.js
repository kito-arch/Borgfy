...
export default function Section5(props){
    return(
        <div className = {`${styles.container}`}>
            ...
            <p data-aos-offset = {-900*scroll} data-aos = 'fade-up' data-aos-duration = '3000' style = {{margin: 'auto', marginBottom: '50px', width: 'fit-content'}} className = {`${styles.heading}`}>The development team includes the following professionals:</p>
            
            <div data-aos-offset = {-1000*scroll} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.innerContainer}`}>
            ...
            <div data-aos-offset = {-1100*scroll} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.innerContainer}`}>
            ...
            <div data-aos-offset = {-1200*scroll} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.innerContainer}`}>
            ...
            <div data-aos-offset = {-1300*scroll} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.innerContainer}`}>
            ...
            <div data-aos-offset = {-1400*scroll} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.innerContainer}`}>
            ...
            <div data-aos-offset = {-1500*scroll} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.innerContainer}`}>
