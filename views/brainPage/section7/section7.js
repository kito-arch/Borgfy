...
export default function(props){
    return(
        <div data-aos-offset = {-1600*(screen.width <= 480 ? mobscroll : myscroll)} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.container}`}>

            <div className='hide_in_mobile' style = {{zIndex: '1', position: 'absolute', top: '370px', left: '30%'}}>
                <Image priority  src = './brain_sec7_image.png' width = '734px' height = '450px'/>
            </div>            
