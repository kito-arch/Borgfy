    ...
    return(
        <div className = {`${styles.container}`}>
            ...
            <div style = {{zIndex: '1', position: 'absolute', bottom: '-100px', right: '-11rem'}}>
                <Image priority  src = '/../public/brain_sec6_image.png' width = '344px' height = '344px'/>
            </div>

            <div className = {`${styles.stretchBetween}`}>

                <div data-aos-offset = {-1700*scroll} data-aos = 'fade-right' data-aos-duration = '3000' className = {`${styles.innerContainer}`}>
                ...
                <div data-aos-offset = {-1700*scroll} data-aos = 'fade-left' data-aos-duration = '3000' className = {`${styles.innerContainer}`}>
