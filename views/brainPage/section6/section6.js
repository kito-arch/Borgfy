    ...
    return(
        <div className = {`${styles.container}`}>
            ...
            <div className = {`${styles.stretchBetween}`}>
                ...
                <div data-aos-offset = {-1700+scroll} data-aos = 'fade-right' data-aos-duration = '1000' className = {`${styles.innerContainer}`}>
                ...
                <div data-aos-offset = {-1700+scroll} data-aos = 'fade-left' data-aos-duration = '1000' className = {`${styles.innerContainer}`}>
