        ...
        <div className = {`${styles.container}`}>
            <div className = {`${styles.stretchBetween}`}>
                ...
                <div className = {`${styles.innerContainer}`}>
                    <p className = {`${styles.heading}`}>Idea Mapping</p>
