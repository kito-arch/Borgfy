        ...
        <div className = {`${styles.container}`}>
            <div className = {`${styles.stretchBetween}`}>
                ...
                <div className = {`${styles.innerContainer}`}>
                    <p data-aos-offset = {-700*scroll} data-aos = 'fade-right' data-aos-duration = '3000' className = {`${styles.heading}`}>Idea Mapping</p>
                    <p data-aos-offset = {-700*scroll} data-aos = 'fade-right' data-aos-duration = '3000' className = {`${styles.text}`}>
