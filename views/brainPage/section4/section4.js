        ...
        <div className = {`${styles.container}`}>
            <div className = {`${styles.stretchBetween}`}>
                ...
                <div className = {`${styles.innerContainer}`}>
                    <p data-aos-offset = "-700" data-aos = 'fade-right' data-aos-duration = '1000' className = {`${styles.heading}`}>Idea Mapping</p>
                    <p data-aos-offset = "-700" data-aos = 'fade-right' data-aos-duration = '1000' className = {`${styles.text}`}>
