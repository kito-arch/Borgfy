...
export default function Section2(props){
    return(
        <div className = {`${styles.container}`}>
            <p data-aos-offset = {-300+scroll} data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.topHeading}`}>Borgfy Has a Team of Daydreamers to Keep Dreaming New Ideas!</p>
            ...
            <div className = {`${styles.innerContainer}`}>
                ...
                <div style = {{position: 'relative'}}>
                    ...
                    <br/>
                    <p data-aos-offset = {-300+scroll} data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.text}`}>The second thing is that you need to say “no” to derive a similar solution to diverse problems. Instead, build a solution to the problems that need your dedication, as they are necessary to be transformed. Thirdly, your problem should be big enough and visionary that it will transform millions of lives. </p>
                    <br/>
                    <p data-aos-offset = {-300+scroll} data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.text}`}>We, at Borgfy, are experts at identifying problems. We make sure our entrepreneurs or businesses are properly aligned toward their mission and vision within our great thought leadership process. This process is about brainstorming and visualizing ideas to make a change.</p>
                </div>
            </div>
        </div>
    )
