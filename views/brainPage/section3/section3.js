    ...
    return(
        <div className = {`${styles.container}`}>
            ...
            <div className = {`${styles.stretchBetween}`}>
                ...
                <div data-aos-offset = {-500*scroll} data-aos = 'fade-left' data-aos-duration = '1000' className = {`${styles.innerContainer}`}>
            ...
            <div data-aos-offset = {-500*scroll} data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.lastContainer}`}>
