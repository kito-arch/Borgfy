...
export default function Section3(props){
    return(
        <div className = {`${styles.container}`}>
            ...
            <p data-aos-offset = "-500" data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.heading}`}>03. Whom are we going to sell?</p>
            
            <div className = {`${styles.stretchBetween}`}>
                <div data-aos-offset = "-500" data-aos = 'fade-right' data-aos-duration = '1000' className = {`${styles.innerContainer}`}>
                ...
                <div data-aos-offset = "-500" data-aos = 'fade-left' data-aos-duration = '1000' className = {`${styles.innerContainer}`}>
            ...
            <div data-aos-offset = "-500" data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.lastContainer}`}>
