    ...
    return(
        <div className = {`${styles.container}`}>
            ...
            <div style = {{position: 'absolute', top: '84px', left: '0'}}>
                <Image priority  src = './brain_sec3_image.png' width = '552px' height = '589px'/>
            </div>
            ...
            <p data-aos-offset = {-500*(screen.width <= 480 ? mobscroll : myscroll)} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.heading}`}>03. Whom are we going to sell?</p>
            ...
            <div className = {`${styles.stretchBetween}`}>
                ...
                <div data-aos-offset = {-500*(screen.width <= 480 ? mobscroll : myscroll)} data-aos = 'fade-left' data-aos-duration = '3000' className = {`${styles.innerContainer}`}>
            ...
            <div data-aos-offset = {-500*(screen.width <= 480 ? mobscroll : myscroll)} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.lastContainer}`}>
