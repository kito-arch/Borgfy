...
export default function Section2(props){
    ...
    return(
        <div className = {`${styles.container}`}>
            <p data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*300} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.heading}`}>How Can We Help?</p>

            <div id = "secondslider" className = {`${styles.stretchBetween}`}>

                <div className = {`${styles.innerContainer}`}>

                    <div data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*300} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.box}`}>
                        <div style = {{width: 'fit-content', margin: 'auto', marginBottom: '62px'}}>
                            <Image priority  src = './landing_sec2_image1.png' width = '189px' height = '189px' />
                        </div>
                    ...
                    <div data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*300} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.box}`}>
                        <div style = {{width: 'fit-content', margin: 'auto', marginBottom: '62px'}}>
                            <Image priority  src = './landing_sec2_image2.png' width = '189px' height = '189px' />
                        </div>
                    ...
                    <div data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*300} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.box}`}>
                        <div style = {{width: 'fit-content', margin: 'auto', marginBottom: '62px'}}>
                            <Image priority  src = './landing_sec2_image3.png' width = '189px' height = '189px' />
                        </div>
                ...
                <div className = {`${styles.innerContainer}`}>
                    ...
                    <div data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*300} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.box}`}>
                        <div style = {{width: 'fit-content', margin: 'auto', marginBottom: '62px'}}>
                            <Image priority  src = './landing_sec2_image4.png' width = '189px' height = '189px' />
                        </div>
                    ...
                    <div data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*300} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.box}`}>
                        <div style = {{width: 'fit-content', margin: 'auto', marginBottom: '62px'}}>
                            <Image priority  src = './landing_sec2_image5.png' width = '189px' height = '189px' />
                        </div>
                    ...
                    <div data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*300} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.box}`}>
                        <div style = {{width: 'fit-content', margin: 'auto', marginBottom: '62px'}}>
                            <Image priority  src = './landing_sec2_image6.png' width = '189px' height = '189px' />
                        </div>
            ...
            <div className='hide_in_mobile' style = {{display: 'flex', alignItems: 'center', justifyContent: 'center', margin: 'auto', width: 'fit-content', marginTop: '40px'}}>
                <div onClick={()=>{setKon(0)}} style = {{marginRight: '10px', cursor: 'pointer'}}>
                    {kon == 0 ? 
                            <Image priority  src = './landing_sec2_filled_ellipse.png' width = '26px' height = '26px' />
                    :
                            <Image priority  src = './landing_sec2_empty_ellipse.png' width = '26px' height = '26px' />
                    }
                </div>
