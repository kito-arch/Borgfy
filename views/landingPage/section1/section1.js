    ...
    return(
        <div className = {`${styles.container}`}>
            ...
            <div style = {{position: 'absolute', top: '0px', right: '-12rem'}}>
                <Image src = '/../public/landing_sec1_back.png' width = '1410px' height = '750px' />
            </div>
            ...
            <p data-aos-offset = "-300" data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.heading}`}>Why The Businesses Needs An Apps ?</p>
            <p data-aos-offset = "-300" data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.text}`}>The answer is simple and short: businesses are transforming within digital transformation and people are focusing more on scalability and mobility of business using mobile apps to reach more audience in less time.</p>
        </div>      
    )
}