...
export default function Section1(props){
    return(
        <div className = {`${styles.container}`}>
            ...
            <p className = {`${styles.heading}`}>Why The Businesses Needs An Apps ?</p>
            <p className = {`${styles.text}`}>The answer is simple and short: businesses are transforming within digital transformation and people are focusing more on scalability and mobility of business using mobile apps to reach more audience in less time.</p>
        </div>      
    )
}