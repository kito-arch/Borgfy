...
export default function Section6(props){
    return(
        <div className = {`${styles.container}`}>
            <p data-aos-offset = "-1700" data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.topHeading}`}>Tools We used</p>
            <p data-aos-offset = "-1700" data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.heading}`}>Native and Hybrid APP</p>

            <div className = {`${styles.stretchBetween}`}>
                <div data-aos-offset = "-1500" data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.single}`}>
            ...
            <div className = {`${styles.stretchBetween}`}>
                <div data-aos-offset = "-1700" data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.single}`}>
            ...
            <div className = {`${styles.stretchBetween}`}>
                <div data-aos-offset = "-1900" data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.single}`}>
            ...
            <div className = {`${styles.stretchBetween}`}>
                <div data-aos-offset = "-2100" data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.single}`}>
