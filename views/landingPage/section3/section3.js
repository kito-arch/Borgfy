...
export default function Section3(props){
    return(
        <div className = {`${styles.container}`}>
            <p data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*500} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.heading}`}>Our Approach</p>

            <div className = {`${styles.stretchBetween}`}>

                <div data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*600} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.box}`}>
                ...
                <div data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*700} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.box}`}>
                    <div className = {`${styles.numberContainer}`}>
