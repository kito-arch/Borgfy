...
export default function Section3(props){
    return(
        <div className = {`${styles.container}`}>
            <p data-aos-offset = {-scroll*500} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.heading}`}>Our Approach</p>

            <div className = {`${styles.stretchBetween}`}>

                <div data-aos-offset = {-scroll*600} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.box}`}>
                ...
                <div data-aos-offset = {-scroll*700} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.box}`}>
                    <div className = {`${styles.numberContainer}`}>
