...
export default function Section6(props){
    return(
        <div className = {`${styles.container}`}>
            <div data-aos-offset = "-1000" data-aos = 'fade-left' data-aos-duration = '1000' className = {`${styles.headingContainer}`}>
            ...
            <div className = {`${styles.startBetween}`}>
                ...
                <p data-aos-offset = "-1200" data-aos = 'fade-left' data-aos-duration = '1000'  className = {`${styles.text}`}>Developing AI recommends the right product based on screen analysis.<br/><br/>Also, Including AR features that would provide users with real-time analysis and suggest users the right solutions.</p>
            </div>

            <div className = {`${styles.startBetween}`}>
                <p data-aos-offset = "-1200" data-aos = 'fade-right' data-aos-duration = '1000'  className = {`${styles.text}`}>Additionally, acquiring information based on the make-up product, price, quality, and reviews and updating the information over time.<br/><br/>Providing all the features that would be comprehensive to provide for a real-time view of the face while experimenting with make-up. And enhancing the user experience to luxury.</p>
