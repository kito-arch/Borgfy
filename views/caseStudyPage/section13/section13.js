...
export default function Section13(props){
    return(
        <div className = {`${styles.container}`}>
            ...
            <div data-aos-offset = "-4200" data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.headingContainer}`}>
            ...
            <p data-aos-offset = "-4200" data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.text}`}>Through our collaboration with we, we made it possible for users to get all the skincare solutions they need from a single app. Also, we made improvements so that the user experience is more of a luxury than a pain point in the process.</p>
        </div>
    )
}