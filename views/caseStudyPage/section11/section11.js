...
export default function Section11(props){
    return(
        <div className = {`${styles.container}`}>
            ...
            <div data-aos-offset = {-scroll*3200} data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.startBetween}`}>
            ...
            <div className = {`${styles.centerCenter}`}>
                <Image src = './case_sec11_image1.png' width = '1222px' height = '591px' />
            </div>

            <div className = {`${styles.centerCenter}`}>
                <div style = {{width: '1222px', marginTop: '50px'}} className = {`${styles.stretchBetween}`}>
                    <Image src = './case_sec11_image2.png' width = '591px' height = '600px' />
                    <Image src = './case_sec11_image3.png' width = '591px' height = '600px' />
                </div>
            </div>
        </div>
    )
