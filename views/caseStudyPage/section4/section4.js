...
export default function Section4(props){
    return(
        <div className = {`${styles.container}`}>
            ...
            <div data-aos-offset = "-800" data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.headingContainer}`}>
