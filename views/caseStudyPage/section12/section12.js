...
export default function Section12(props){
    return(
        <div className = {`${styles.container}`}>
            ...
            <div data-aos-offset = "-3800" data-aos = 'fade-right' data-aos-duration = '1000' className = {`${styles.headingContainer}`}>
