        ...
        <StandardLayout backgroundColor = 'black'>
            ...
            <div className = {`${styles.container}`}>
                ...
                <PaddingLayout>
                    ...
                    <div data-aos-offset = {-scroll*1500} data-aos = 'fade-right' data-aos-duration = '3000' className = {`${styles.centerEnd}`}>
                ...
                <PaddingLayout>
                    ...
                    <div data-aos-offset = {-scroll*300} data-aos = 'fade-right' data-aos-duration = '3000' className = {`${styles.centerStart}`}>
                ...
                <PaddingLayout>
                    ...
                    <div data-aos-offset = {-scroll*800} data-aos = 'fade-left' data-aos-duration = '3000' className = {`${styles.centerEnd}`}>
                ...
                <PaddingLayout>
                    ...
                    <div data-aos-offset = {-scroll*900} data-aos = 'fade-right' data-aos-duration = '3000' className = {`${styles.centerStart}`}>
