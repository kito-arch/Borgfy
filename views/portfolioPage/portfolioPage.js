                ...
                {(category == 0 || category == 2) &&
                    <PaddingLayout>
                        ...
                        <div id = "atomic" data-aos-offset = {-scroll*300} data-aos = 'fade-right' data-aos-duration = '3000' className = {`${styles.centerStart}`}>
                            <Card1 width = '960px' height = '637px' im = '/../public/port_back_1_.png' heading = 'Atomic' subheading = 'Design' text = 'A social blockchain-based app designed for sharing thoughts hacks inspired by Twitter UX.' headingMarginBottom = '14px' textMarginBottom = '43px' />
                        </div>
                        </div>
                    </PaddingLayout>
                }
                    ...
                    <PaddingLayout>
                        <div style = {{paddingBottom: '38px'}} className={styles.mb}>
                            ...
                            <div data-aos-offset = {-scroll*5000} data-aos = 'fade-left' data-aos-duration = '3000' className = {`${styles.centerEnd}`}>
                                <Card1 width = '955px' height = '696px' im = '/../public/port_back_2_.png'  heading = 'Borgfy' subheading = 'Design' text = 'Its our company corporate website UIUX earlier designed based on software agency model.' headingMarginBottom = '14px' textMarginBottom = '43px' />
                            </div>
                        </div>
                    </PaddingLayout>
                }
                ...
                {(category == 0 || category == 3 || category == 2) &&
                    <PaddingLayout>
                        ...
                        <div data-aos-offset = {-scroll*1000} data-aos = 'fade-left' data-aos-duration = '3000' className = {`${styles.centerEnd}`}>
                            <Card1 web = "https://sagecreekra.com/" width = '823px' height = '817px' im = '/../public/port_back_6_.png' subheading = "Design   |   Development" heading = 'Sage Creek' text = 'Sage Creekra is Real Estate community website, we helped them transform the website look and performance with finest quality.' headingMarginBottom = '60px' textMarginBottom = '68px' />
                        </div>
                        </div>
                    </PaddingLayout>
                }
                ...
                {(category == 0 || category == 1 || category == 2) &&
                    <PaddingLayout>
                        ...
                        <div data-aos-offset = {-scroll*1500} data-aos = 'fade-right' data-aos-duration = '3000' className = {`${styles.centerStart}`}>
                            <Card1 android = "https://play.google.com/store/apps/details?id=com.first.faebikes.faeconsumerapp&hl=en_IN&gl=US" apple = "https://apps.apple.com/in/app/charzer/id1549198545" width = '953px' height = '666px' im = '/../public/port_back_7_.png' alternate = {true} subheading = "Design   |   Development" heading = 'Charzer' text = 'Charzer is an IoT EV Charging Cross-Platform App Build On React native Platform With Full Dynamic UI/UX And Detailing its has full custom development of Frontend /Backend Admin Side for Dynamic Data build on Django' headingMarginBottom = '60px' textMarginBottom = '71px' />
                        </div>
                        </div>
                    </PaddingLayout>
                }
                ...
                {(category == 0 || category == 2) &&
                    <PaddingLayout>
                        ...
                        <div data-aos-offset = {-scroll*1600} data-aos = 'fade-left' data-aos-duration = '3000' className = {`${styles.centerEnd}`}>
                            <Card1 width = '871px' height = '616px' im = '/../public/port_back_8_.png' subheading = "Design" heading = 'Online Edtech' text = 'Website Designed for Online Coaching Centre for Civil Services Exam For Online Live Video Interaction on Demand Courses Training.' headingMarginBottom = '60px' noIcon = {true} />
                        </div>
                        </div>
                    </PaddingLayout>
                }
                ...
                {(category == 0 || category == 2) &&
                    <PaddingLayout>
                        ...
                        <div data-aos-offset = {-scroll*1700} data-aos = 'fade-right' data-aos-duration = '3000' className = {`${styles.centerStart}`}>
                            <Card1 width = '738px' height = '604px' im = '/../public/port_back_9_.png' subheading = "Design" heading = 'Kitchenware' text = 'Kitchenware Website Designed is an informative website for kitchenware startups for branding.' headingMarginBottom = '60px' noIcon = {true} />
                        </div>
                        </div>
                    </PaddingLayout>
                }
