        ...
        <StandardLayout backgroundColor = 'black'>
            ...
            <div className = {`${styles.container}`}>
                ...
                {(category == 0 || category == 1) &&
                    <PaddingLayout>
                        <Image src = '/../public/qool_qatar_back.png' layout = 'fill' />
                ...
                {(category == 0 || category == 1 || category == 2) &&
                    <PaddingLayout>
                        <Image src = '/../public/port_back_1.png.png' layout = 'fill' />
                        <div style = {{position: 'absolute', top: '3rem', right: '2rem'}}>
                            <Image src = {'/../public/port_back_1_.png'} width = {'960px'} height = {'637px'}></Image>
                        </div>
                ...
                {(category == 0 || category == 2) &&
                    <PaddingLayout>
                        <Image src = '/../public/port_back_2.png.png' layout = 'fill' />
                        <div style = {{position: 'absolute', top: '3rem', left: '4rem'}}>
                            <Image src = {'/../public/port_back_2_.png'} width = {'955px'} height = {'696px'}></Image>
                        </div>
                ...
                {(category == 0 || category == 1) &&
                    <PaddingLayout>
                        <Image src = '/../public/port_back_3.png.png' layout = 'fill' />
                        <div style = {{position: 'absolute', top: '6rem', right: '4rem'}}>
                            <Image src = {'/../public/port_back_3_.png'} width = {'799px'} height = {'608px'}></Image>
                        </div>
                ...
                {(category == 0 || category == 1 || category == 2) &&
                    <PaddingLayout>
                        <Image src = '/../public/port_back_4.png.png' layout = 'fill' />
                        <div style = {{position: 'absolute', top: '14rem', left: '4rem'}}>
                            <Image src = {'/../public/port_back_4_.png'} width = {'901.7142857142858px'} height = {'501.42857142857144px'}></Image>
                        </div>
                ...
                {(category == 0 || category == 1) &&
                    <PaddingLayout>
                        <Image src = '/../public/port_back_5.png.png' layout = 'fill' />
                        <div style = {{position: 'absolute', top: '6rem', right: '4rem'}}>
                            <Image src = {'/../public/port_back_5_.png'} width = {'740px'} height = {'673px'}></Image>
                        </div>
                ...
                {(category == 0 || category == 3) &&
                    <PaddingLayout>
                        <Image src = '/../public/port_back_6.png.png' layout = 'fill' />
                        <div style = {{position: 'absolute', top: '-10px', left: '4rem'}}>
                            <Image src = {'/../public/port_back_6_.png'} width = {'764.2142857142857px'} height = {'758.6428571428571px'}></Image>
                        </div>
                ...
                {(category == 0 || category == 1) &&
                    <PaddingLayout>
                        <Image src = '/../public/port_back_7.png.png' layout = 'fill' />
                        <div style = {{position: 'absolute', top: '10rem', right: '10rem'}}>
                            <Image src = {'/../public/port_back_7_.png'} width = {'794.1666666666666px'} height = {'555px'}></Image>
                        </div>
                ...
                {(category == 0 || category == 2) &&
                <PaddingLayout>
                        <Image src = '/../public/port_back_8.png.png' layout = 'fill' />
                        <div style = {{position: 'absolute', top: '3rem', left: '4rem'}}>
                            <Image src = {'/../public/port_back_8_.png'} width = {'871px'} height = {'616px'}></Image>
                        </div>
                ...
                {(category == 0 || category == 2) &&
                <PaddingLayout>
                        <Image src = '/../public/port_back_9.png.png' layout = 'fill' />
                        <div style = {{position: 'absolute', top: '3rem', right: '4rem'}}>
                            <Image src = {'/../public/port_back_9_.png'} width = {'738px'} height = {'604px'}></Image>
                        </div>
