    ...
    return(
        <div className = {`${styles.container}`}>
            ...
            <div className = {`${styles.startBetween}`}>
                ...
                <p data-aos-offset = {-scroll*1200} data-aos = 'fade-left' data-aos-duration = '1000'  className = {`${styles.text}`}>{props?.useCase?.challenge1_text}</p>
            </div>

            <div className = {`${styles.startBetween}`}>
                <p data-aos-offset = {-scroll*1200} data-aos = 'fade-right' data-aos-duration = '1000'  className = {`${styles.text}`}>{props?.useCase?.challenge2_text}</p>
