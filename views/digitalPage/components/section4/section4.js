...
export default function Section4(props){
    return( 
        <div className = {`${styles.container}`}>
            ...
            <p data-aos-offset = "-300" data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.heading}`}>Venture Building Journey/Process</p>
            <p data-aos-offset = "-300" data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.text}`}>Get through the venture building journey or strategies that we follow:</p>
            <div  data-aos-offset = "-400" data-aos = 'fade-up' data-aos-duration = '1000'>
            ...
            <div  data-aos-offset = "-500" data-aos = 'fade-up' data-aos-duration = '1000'>
            ...
            <div  data-aos-offset = "-600" data-aos = 'fade-up' data-aos-duration = '1000'>
            ...
            <div  data-aos-offset = "-700" data-aos = 'fade-up' data-aos-duration = '1000'>
            ...
            <div  data-aos-offset = "-800" data-aos = 'fade-up' data-aos-duration = '1000'>
