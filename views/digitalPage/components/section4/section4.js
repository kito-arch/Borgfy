    ...
    return( 
        <div className = {`${styles.container}`}>
            <div style = {{position: 'absolute', top: '-10px', left: '-12rem'}}>
                <Image priority  src = '/../public/venture_building_top_ellipse.png' width = '450px' height = '450px' />
            </div>
            <div style = {{position: 'absolute', bottom: '180px', left: '873px'}}>
                <Image priority  src = '/../public/venture_building_bottom_ellipse.png' width = '120px' height = '120px' />
            </div>
            <div style = {{position: 'absolute', bottom: '50px', right: '-180px'}}>
                <Image priority  src = '/../public/venture_building_right_ellipse.png' width = '400px' height = '400px' />
            </div>
            <div style = {{position: 'absolute', bottom: '140px', left: '-90px'}}>
                <Image priority  src = '/../public/venture_building_left_ellipse.png' width = '204px' height = '204px' />
            </div>
            ...
            <div  data-aos-offset = {-scroll*400} data-aos = 'fade-up' data-aos-duration = '3000'>
            ...
            <div  data-aos-offset = {-scroll*500} data-aos = 'fade-up' data-aos-duration = '3000'>
            ...
            <div  data-aos-offset = {-scroll*600} data-aos = 'fade-up' data-aos-duration = '3000'>
            ...
            <div  data-aos-offset = {-scroll*700} data-aos = 'fade-up' data-aos-duration = '3000'>
            ...
            <div  data-aos-offset = {-scroll*800} data-aos = 'fade-up' data-aos-duration = '3000'>
