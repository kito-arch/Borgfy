...
export default function Section5(props){
    return(
        <div className = {`${styles.container}`}>
            <p data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*1000} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.heading}`}>Incubators Vs Accelerators Vs Venture Studio</p>
            <p data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*1200} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.text}`}>Venture Studio is by far the most refined version of Incubators and Accelerators.</p>
            <div data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*1200} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.top}`}>
            ...
            <div data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*1300} data-aos = 'fade-up' data-aos-duration = '3000'>
            ...
            <div data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*1400} data-aos = 'fade-up' data-aos-duration = '3000'>
            ...
            <div data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*1500} data-aos = 'fade-up' data-aos-duration = '3000'>
            ...
            <div data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*1600} data-aos = 'fade-up' data-aos-duration = '3000'>
            ...
            <div data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*1700} data-aos = 'fade-up' data-aos-duration = '3000'>
                <Row heading = 'Act As Co-Founder' c1 = 'Never' c2 = 'Never' c3 = 'Never' c4 = 'Does'  /> 
            </div>
            <div data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*1800} data-aos = 'fade-up' data-aos-duration = '3000'>
            ...
            <div data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*1900} data-aos = 'fade-up' data-aos-duration = '3000'>
