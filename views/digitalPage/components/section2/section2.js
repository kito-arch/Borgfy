...
export default function Section2(props){
    return(
        <div className = {`${styles.container}`}>
            <p  data-aos-offset = "-500" data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.heading}`}>How does a venture studio<br/>work?</p>
            <p  data-aos-offset = "-500" data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.text}`}>This revolutionary business model works on promoting or encouraging startups that have the potential to grow. Building an innovative business model from scratch is challenging. So, startups acquisition is favored under the venture studio model.<br/>Here is how it works. </p>

            <div style = {{marginTop: '43px'}} className = {`${styles.innerContainer}`}>
                <div  data-aos-offset = "-300" data-aos = 'fade-right' data-aos-duration = '1000' className = {`${styles.innerSingleContainer}`}>
                ...
                <div  data-aos-offset = "-300" data-aos = 'fade-left' data-aos-duration = '1000' className = {`${styles.innerSingleContainer}`}>
                    <p className = {`${styles.subheading}`}>Skills and Innovative Mindset</p>
                    <p className = {`${styles.text}`}>It requires innovative skills and a mindset.  This rare combo excels in the market dynamics. The business becomes future-ready with it, as the change is certain. With creativity and innovation, adapting to the change turns easier. </p>
                </div>
            </div>
            ...
            <div style = {{marginTop: '55px'}} className = {`${styles.innerContainer}`}>
                <div data-aos-offset = "-500" data-aos = 'fade-right' data-aos-duration = '1000' className = {`${styles.innerSingleContainer}`}>
                ...
                <div data-aos-offset = "-500" data-aos = 'fade-left' data-aos-duration = '1000' className = {`${styles.innerSingleContainer}`}>
            ...
            <div data-aos-offset = "-500" data-aos = 'fade-up' data-aos-duration = '1000' style = {{marginTop: '55px'}} className = {`${styles.innerContainer}`}>
                <div style = {{width : '100%'}}>
