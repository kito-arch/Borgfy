    ...
    return(
        <div className = {`${styles.container}`}>
            ...
            <div style = {{position: 'absolute', bottom: '0px', right: '-12rem'}}>
                <Image priority  src = '/../public/venture_advantages_dot.png' width = '198px' height = '348px' />
            </div>

            <div className={styles.imCon} data-aos-offset = {-scroll*2300} data-aos = 'fade-up' data-aos-duration = '3000'>
            ...
            <div className={styles.imCon} data-aos-offset = {-scroll*2400} data-aos = 'fade-up' data-aos-duration = '3000'>
            ...
            <div className={styles.imCon} data-aos-offset = {-scroll*2500} data-aos = 'fade-up' data-aos-duration = '3000'>
            ...
            <div className={styles.imCon} data-aos-offset = {-scroll*2600} data-aos = 'fade-up' data-aos-duration = '3000'>
            ...
            <div className={styles.imCon} data-aos-offset = {-scroll*2700} data-aos = 'fade-up' data-aos-duration = '3000'>
            ...
            <div className={styles.imCon} data-aos-offset = {-scroll*2800} data-aos = 'fade-up' data-aos-duration = '3000'>
