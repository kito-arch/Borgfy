...
export default function Section5(props){
    return(
        <div className = {`${styles.container}`}>
            ...
            <p className = {`${styles.heading}`}>Working Of Artificial Intelligence</p>
            <p className = {`${styles.text}`}>AI is a complete process to train machines and get better predictions. For the understanding of beginners, AI has 5 different parts, and we the best AI company take care of all of them. To understand our services it is important to understand Ai first so look at its parts.</p>
