    ...
    return(
        <div className = {`${styles.container}`}>
            ...
            <div style = {{position: 'absolute', top: '150px', right: '-12rem'}}>
                <Image src = './ai_sec6_icon1.png' width = '200px' height = '200px'/>
            </div>

            <div style = {{position: 'absolute', bottom: '0', left: '-12rem'}}>
                <Image src = './ai_sec6_icon2.png' width = '150px' height = '190px'/>
            </div>

            <p  data-aos-offset = {-800*scroll} data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.heading}`}>Working Of Artificial Intelligence</p>
            <p  data-aos-offset = {-8500*scroll} data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.text}`}>AI is a complete process to train machines and get better predictions. For the understanding of beginners, AI has 5 different parts, and we the best AI company take care of all of them. To understand our services it is important to understand Ai first so look at its parts.</p>

            <div  data-aos-offset = {-900*scroll} data-aos = 'fade-up' data-aos-duration = '1000'>
            ...
            <div  data-aos-offset = {-1000*scroll} data-aos = 'fade-up' data-aos-duration = '1000'>
