    ...
    return(
        <div className = {`${styles.container}`}>
            ...
            <div style = {{position: 'absolute', left: '-12rem', bottom: '113px'}}>
                <Image priority  src = './ai_sec4_dots.png' width = '120px' height = '274px' />
            </div>

            <p  data-aos-offset = {-600*(screen.width <= 480 ? mobscroll : myscroll)} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.heading}`}>Data Science & Machine Learning Applications</p>
            <p  data-aos-offset = {-600*(screen.width <= 480 ? mobscroll : myscroll)} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.text}`}>As more and more data is created to scale the industrial outcome the use of Data Science is increasing. With the help of AI and analytics industries are becoming more profoundly able for mass-producing digital and physical products of a grand scale.it helps in estimating your customer behaviour,product lifecycle and better insights of future</p>

            <div className = {`${styles.stretchBetween}`}>

                <div  data-aos-offset = {-700*(screen.width <= 480 ? mobscroll : myscroll)} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.card}`}>
                    <div className = {`${styles.cardImage}`}>
                        <Image priority  src = './ai_sec4_icon1.png' width = '93px' height = '93px' />
                    </div>
                ...
                <div  data-aos-offset = {-700*(screen.width <= 480 ? mobscroll : myscroll)} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.card}`}>
                    <div className = {`${styles.cardImage}`}>
                        <Image priority  src = './ai_sec4_icon2.png' width = '93px' height = '93px' />
                    </div>
                ...
                <div  data-aos-offset = {-700*(screen.width <= 480 ? mobscroll : myscroll)} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.card}`}>
                    <div className = {`${styles.cardImage}`}>
                        <Image priority  src = './ai_sec4_icon3.png' width = '93px' height = '93px' />
                    </div>
