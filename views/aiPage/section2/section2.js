    ...
    return(
        <div className = {`${styles.container}`}>
            ...
            <div style = {{position: 'absolute', left: '850px', top: '-10px'}}>
                <Image src = './ai_sec2_top.png' width = '215px' height = '215px' />
            </div>

            <div style = {{position: 'absolute', right: '-100px', top: '350px'}}>
                <Image src = './ai_sec2_bottom_right.png' width = '215px' height = '215px' />
            </div>

            <div style = {{position: 'absolute', left: '28px', top: '260px'}}>
                <Image src = './ai_sec2_bottom_left.png' width = '116px' height = '116px' />
            </div>
