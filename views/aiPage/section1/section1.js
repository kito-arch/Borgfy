...
export default function Section1(props){
    return(
        <div className = {`${styles.container}`}>
            ...
            <p className = {`${styles.text}`}>AI stands for Artificial Intelligence. It is a simulation of human intelligence processes by computer systems or machines. The common applications of AI are as follows.</p>
            ...
            <p className = {`${styles.bottomText}`}>Popular teams who use emotech for their daily use.</p>
        </div>
    )
}