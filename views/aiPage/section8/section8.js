...
export default function Section8(props){
    return(
        <div className = {`${styles.container}`}>
            ...
            <p className = {`${styles.boldText}`}>There are other industries like , Pharmaceutical, Marketing and Advertising, Medical Research and many more which are getting huge benefit return Integration of AI</p>

            <p style = {{marginTop: '104px', marginBottom: '40px'}} className = {`${styles.heading}`}>Why We are the Best AI Automation Company?</p>
            <div style = {{width: 'fit-content', marginLeft: 'auto', marginRight: 'auto'}} className = {`${styles.flex}`}>
                <Image src = '/../public/ai_sec8_tick.png' width = '34px' height = '40px' />
                <p className = {`${styles.text} ${styles.tickText}`}>Stock Trading helps to predict behavior of market graph</p>
            </div>
