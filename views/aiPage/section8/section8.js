...
export default function Section8(props){
    return(
        <div className = {`${styles.container}`}>
            ...
            <div data-aos-offset = "-1500" data-aos = 'fade-up' data-aos-duration = '1000'>
            ...
            <div data-aos-offset = "-1700" data-aos = 'fade-up' data-aos-duration = '1000'>
            ...
            <div className = {`${styles.stretchBetween}`}>
                <div data-aos-offset = "-1900" data-aos = 'fade-right' data-aos-duration = '1000' style = {{width: '45%'}}>
                ...
                <div data-aos-offset = "-1900" data-aos = 'fade-left' data-aos-duration = '1000' style = {{width: '45%'}}>
            ...
            <p data-aos-offset = "-2100" data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.boldText}`}>There are other industries like , Pharmaceutical, Marketing and Advertising, Medical Research and many more which are getting huge benefit return Integration of AI</p>

            <p data-aos-offset = "-2200" data-aos = 'fade-up' data-aos-duration = '1000' style = {{marginTop: '104px', marginBottom: '40px'}} className = {`${styles.heading}`}>Why We are the Best AI Automation Company?</p>
            <div data-aos-offset = "-2200" data-aos = 'fade-up' data-aos-duration = '1000' style = {{width: 'fit-content', marginLeft: 'auto', marginRight: 'auto'}} className = {`${styles.flex}`}>
                <Image src = '/../public/ai_sec8_tick.png' width = '34px' height = '40px' />
                <p className = {`${styles.text} ${styles.tickText}`}>Stock Trading helps to predict behavior of market graph</p>
            </div>
