    ...
    return(
        <div className = {`${styles.container}`}>
            ...
            <div className='hide_in_mobile' style = {{position: 'absolute', top: '450px', left: '-150px'}}>
                <Image priority  src = './ai_sec8_icon1.png' width = '300px' height = '314px'/>
            </div>
            <div className='hide_in_mobile' style = {{position: 'absolute', top: '800px', right: '-150px'}}>
                <Image priority  src = './ai_sec8_icon2.png' width = '250px' height = '250px'/>
            </div>
            <div className='hide_in_mobile' style = {{position: 'absolute', bottom: '130px', left: '-150px'}}>
                <Image priority  src = './ai_sec8_icon4.png' width = '200px' height = '200px'/>
            </div>
            <div className='hide_in_mobile' style = {{position: 'absolute', bottom: '60px', right: '-150px'}}>
                <Image priority  src = './ai_sec8_icon5.png' width = '300px' height = '314px'/>
            </div>


            <div data-aos-offset = {-1500*(screen.width <= 480 ? mobscroll : myscroll)} data-aos = 'fade-up' data-aos-duration = '3000'>
                ...
                <div style = {{marginBottom: '73px'}} className = {`${styles.centerBetween}`}>
                    ...
                    <div className = {styles.imCon}>
                        <Image priority  src = './ai_sec8_com1.png' width = '353px' height = '144px' />
                    </div>
                    <div className = {styles.imCon}>
                        <Image priority  src = './ai_sec8_com2.png' width = '296px' height = '159px' />
                    </div>
                    <div className = {styles.imCon}>
                        <Image priority  src = './ai_sec8_com3.png' width = '307px' height = '287px' />
                    </div>
                    <div className = {styles.imCon}>
                        <Image priority  src = './ai_sec8_com4.png' width = '370px' height = '127px' />
                    </div>

                </div>
            </div>

            <div data-aos-offset = {-1700*(screen.width <= 480 ? mobscroll : myscroll)} data-aos = 'fade-up' data-aos-duration = '3000'>
            ...
            <div className = {`${styles.stretchBetween}`}>
                <div className = {styles.ecCon} data-aos-offset = {-1900*(screen.width <= 480 ? mobscroll : myscroll)} data-aos = 'fade-right' data-aos-duration = '3000' style = {{width: '45%'}}>
                    <div style = {{position: 'relative'}}>

                    <div style = {{position: 'absolute', top: '8px', left: '320px'}}>
                        <Image priority  src = './ai_sec8_icon3.png' width = '68px' height = '68px'/>
                    </div>
                    ...
                    <div className = {`${styles.flex}`}>
                        <Image priority  src = './ai_sec8_tick.png' width = '34px' height = '40px' />
                ...
                <div className = {styles.ecCon} data-aos-offset = {-1900*(screen.width <= 480 ? mobscroll : myscroll)} data-aos = 'fade-left' data-aos-duration = '3000' style = {{width: '45%'}}>
            ...
            <p data-aos-offset = {-2100*(screen.width <= 480 ? mobscroll : myscroll)} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.boldText}`}>There are other industries like , Pharmaceutical, Marketing and Advertising, Medical Research and many more which are getting huge benefit return Integration of AI</p>

            <p data-aos-offset = {-2200*(screen.width <= 480 ? mobscroll : myscroll)} data-aos = 'fade-up' data-aos-duration = '3000' style = {{marginTop: '104px', marginBottom: '40px'}} className = {`${styles.heading}`}>Why We are the Best AI Automation Company?</p>
            <div data-aos-offset = {-2200*(screen.width <= 480 ? mobscroll : myscroll)} data-aos = 'fade-up' data-aos-duration = '3000' style = {{width: 'fit-content', marginLeft: 'auto', marginRight: 'auto'}} className = {`${styles.flex}`}>
                <Image priority  src = './ai_sec8_tick.png' width = '34px' height = '40px' />
