...
export default function Section8(props){
    return(
        <div className = {`${styles.container}`}>
            ...
            <div data-aos-offset = {-1500*scroll} data-aos = 'fade-up' data-aos-duration = '3000'>
            ...
            <div data-aos-offset = {-1700*scroll} data-aos = 'fade-up' data-aos-duration = '3000'>
            ...
            <p data-aos-offset = {-2100*scroll} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.boldText}`}>There are other industries like , Pharmaceutical, Marketing and Advertising, Medical Research and many more which are getting huge benefit return Integration of AI</p>
