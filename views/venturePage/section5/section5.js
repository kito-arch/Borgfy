...
export default function Section5(props){
    return(
        <div className = {`${styles.container}`}>
            ...
            <p data-aos-offset = "-1500" data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.heading}`}>Lets Us Help You Build Your Digital Transformation Era</p>
            <p data-aos-offset = "-1500" data-aos = 'fade-up' data-aos-duration = '1000' style = {{marginBottom: '3rem'}} className = {`${styles.text}`}>
