...
export default function Section3(props){
    return(
        <div className = {`${styles.container}`}>
            ...
            <p data-aos = 'fade-up' data-aos-duration = '1000' data-aos-offset = "-500" className = {`${styles.heading}`}>Journey of Digital Transformation that We Define</p>
            <p data-aos = 'fade-up' data-aos-duration = '1000' data-aos-offset = "-500" className = {`${styles.desc}`}>Our incorporation helps scale your cutting-edge ideas through the right fit digital transformation journey. Our growth partners let you become a growth hacker through end-to-end business assistance. We follow a definite way, which is here for your notice:</p>
            <div className = {`${styles.stretchBetween}`}>
                <div data-aos-offset = "-500" data-aos = 'fade-up' data-aos-duration = '1000' style = {{width: '30%'}}>
