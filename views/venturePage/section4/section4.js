    ...
    return(
        <div className = {`${styles.container}`}>
            ...
            {/* <div style = {{position: 'absolute', top: 0, left: '-12rem'}}>
                <Image src = './digital_advantages_back.png' width = '3000px' height = '900px'/>
            </div> */}

            <p data-aos-offset = {scroll-1000} data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.heading}`}>Advantages of Digital Transformation</p>

            <div className = {`${styles.stretchBetween}`}>
                <div data-aos-offset = {scroll-1000} data-aos = 'fade-right' data-aos-duration = '1000' style = {{width: '49%'}}>
                ...
                <div data-aos-offset = {scroll-1000} data-aos = 'fade-left' data-aos-duration = '1000' style = {{width: '49%'}}>
