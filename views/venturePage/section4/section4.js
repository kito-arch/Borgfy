...
export default function Section4(props){
    return(
        <div className = {`${styles.container}`}>
            ...
            <p data-aos-offset = "-1000" data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.heading}`}>Advantages of Digital Transformation</p>

            <div className = {`${styles.stretchBetween}`}>
                <div data-aos-offset = "-1000" data-aos = 'fade-right' data-aos-duration = '1000' style = {{width: '49%'}}>
                ...
                <div data-aos-offset = "-1000" data-aos = 'fade-left' data-aos-duration = '1000' style = {{width: '49%'}}>
