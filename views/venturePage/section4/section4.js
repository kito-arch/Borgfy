    ...
    return(
        <div className = {`${styles.container}`}>
            ...
            <div className = {`${styles.stretchBetween}`}>
                <div data-aos-offset = {-scroll*1000} data-aos = 'fade-right' data-aos-duration = '3000' style = {{width: '49%'}}>
                ...
                <div data-aos-offset = {-scroll*1000} data-aos = 'fade-left' data-aos-duration = '3000' style = {{width: '49%'}}>
