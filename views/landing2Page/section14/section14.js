...
export default function Section14(props){
    return(
        <div className = {`${styles.container}`}>
            ...
            <p data-aos-offset = "-4800" data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.heading}`}>You need to Choose Us</p>
            <p data-aos-offset = "-4800" data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.subheading}`}>The World is too noise tune to Borgy Signal</p>


            <div data-aos-offset = "-5000" data-aos = 'fade-up' data-aos-duration = '1000' style = {{padding: '19px 16px', paddingRight: '131px', marginBottom: '93px'}} className = {`${styles.box}`}>
            ...
            <div data-aos-offset = "-5100" data-aos = 'fade-up' data-aos-duration = '1000' style = {{padding: '25px 69px 28px 55px', marginBottom: '77px', marginLeft: 'auto'}} className = {`${styles.box}`}>
            ...
            <div data-aos-offset = "-5300" data-aos = 'fade-up' data-aos-duration = '1000' style = {{padding: '18px 47px 39px', marginBottom: '-142px'}} className = {`${styles.box}`}>
            ...
            <div data-aos-offset = "-5300" data-aos = 'fade-up' data-aos-duration = '1000' style = {{padding: '19px 16px', paddingRight: '69px', marginLeft: 'auto'}} className = {`${styles.box}`}>
