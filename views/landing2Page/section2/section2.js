        ...
        <div className = {`${styles.container}`}>
            ...
            <div style = {{position: 'relative'}}>
                ...
                <div className = {`${styles.centerCenter}`}>
                    <div className = {`${styles.stretchBetween}`}>
                        <div data-aos-offset = {-scroll*300} data-aos = 'fade-up' data-aos-duration = '3000'  style = {{width: '340px', position: 'relative', paddingTop: '60px'}}>
                            <div style = {{width: 'fit-content', margin: 'auto'}}>
                                <Image priority  src = '/../public/landing2_sec2_image1.png' width = '110px' height = '110px' />
                            </div>
                            <div style = {{position: 'absolute', top: '200px', right: '-150px'}}>
                                <Image priority  src = '/../public/landing2_sec2_arrow1.png' width = '88px' height = '42px' />
                            </div>
                        ...
                        <div data-aos-offset = {-scroll*300} data-aos = 'fade-up' data-aos-duration = '3000'  style = {{width: '340px', position: 'relative'}}>
                            <Image priority  src = '/../public/landing2_sec2_image2.png' width = '110px' height = '110px' />
                            ...
                            <div style = {{position: 'absolute', top: '180px', right: '-150px'}}>
                                <Image priority  src = '/../public/landing2_sec2_arrow2.png' width = '76px' height = '59px' />
                            </div>
                        </div>
                        <div data-aos-offset = {-scroll*300} data-aos = 'fade-up' data-aos-duration = '3000'  style = {{width: '340px', position: 'relative', paddingTop: '60px'}}>
                            <Image priority  src = '/../public/landing2_sec2_image3.png' width = '110px' height = '110px' />
            ...
            <div data-aos-offset = {-scroll*400} data-aos = 'fade-up' data-aos-duration = '3000'  className = {`${styles.bottomContainer}`}>
                {/* <div style = {{position: 'absolute', top: '-100px', left: '-150px'}}>
                    <Image priority  src = '/../public/landing2_sec2_line.png' width = '1410px' height = '39px' />
                </div> */}
                <div style = {{position: 'absolute', top: '-50px', left: '-300px'}}>
                    <Image priority  src = '/../public/landing2_sec2_steve.png' width = '262px' height = '195px' />
                </div>
                <div className = {styles.rocket} style = {{position: 'absolute', top: '-100px', right: '-300px'}}>
                    <Image priority  src = '/../public/landing2_sec2_rocket.png' width = '214px' height = '214px' />
                </div>
