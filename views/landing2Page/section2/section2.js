    ...
    return(
        <div className = {`${styles.container}`}>
            ...
            <div style = {{position: 'relative'}}>
                <p data-aos-offset = {scroll-300} data-aos = 'fade-up' data-aos-duration = '1000'  className = {`${styles.subtext}`}>WHO WE ARE</p>
                <p data-aos-offset = {scroll-300} data-aos = 'fade-up' data-aos-duration = '1000'  className = {`${styles.heading}`}>WE ARE</p>

                <div className = {`${styles.centerCenter}`}>
                    <div className = {`${styles.stretchBetween}`}>
                        <div data-aos-offset = {scroll-300} data-aos = 'fade-up' data-aos-duration = '1000'  style = {{width: '340px', position: 'relative', paddingTop: '60px'}}>
                            <div style = {{width: 'fit-content', margin: 'auto'}}>
                                <Image src = './landing2_sec2_image1.png' width = '110px' height = '110px' />
                            </div>
                            <div style = {{position: 'absolute', top: '200px', right: '-150px'}}>
                                <Image src = './landing2_sec2_arrow1.png' width = '88px' height = '42px' />
                            </div>
                            <p className = {`${styles.text}`}>Venture Builders  and Digital Transformation Experts helping startups and enterprises</p>
                        </div>
                        <div data-aos-offset = {scroll-300} data-aos = 'fade-up' data-aos-duration = '1000'  style = {{width: '340px', position: 'relative'}}>
                            <Image src = './landing2_sec2_image2.png' width = '110px' height = '110px' />
                            ...
                            <div style = {{position: 'absolute', top: '180px', right: '-150px'}}>
                                <Image src = './landing2_sec2_arrow2.png' width = '76px' height = '59px' />
                            </div>
                        </div>
                        <div data-aos-offset = {scroll-300} data-aos = 'fade-up' data-aos-duration = '1000'  style = {{width: '340px', position: 'relative', paddingTop: '60px'}}>
                            <Image src = './landing2_sec2_image3.png' width = '110px' height = '110px' />
            ...
            <div data-aos-offset = {scroll-400} data-aos = 'fade-up' data-aos-duration = '1000'  className = {`${styles.bottomContainer}`}>
                {/* <div style = {{position: 'absolute', top: '-100px', left: '-150px'}}>
                    <Image src = './landing2_sec2_line.png' width = '1410px' height = '39px' />
                </div> */}
