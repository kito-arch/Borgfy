...
export default function Section6(props){
    return(
        <div className = {`${styles.container}`}>
            ...
            <p data-aos-offset = "-1700" data-aos = 'fade-left' data-aos-duration = '1000' className = {`${styles.subheading}`}>DELIVERED</p>
            <p data-aos-offset = "-1700" data-aos = 'fade-left' data-aos-duration = '1000' className = {`${styles.heading}`}>What our Delivered</p>

            <div className = {`${styles.numberContainer}`}>

                <div data-aos-offset = "-1900" data-aos = 'fade-left' data-aos-duration = '1000' >
            ...
            <div className = {`${styles.howContainer}`}>
                ...
                <p data-aos-offset = "-2000" data-aos = 'fade-left' data-aos-duration = '1000' className = {`${styles.heading2}`}>How we work?</p>
                <p data-aos-offset = "-2000" data-aos = 'fade-left' data-aos-duration = '1000' className = {`${styles.subheading2}`}>Bussiness Model</p>

                <div className = {`${styles.stretchBetween}`}>

                    <div data-aos-offset = "-2100" data-aos = 'fade-right' data-aos-duration = '1000' className = {`${styles.boxContainer}`}>
                    ...
                    <div data-aos-offset = "-2100" data-aos = 'fade-left' data-aos-duration = '1000' className = {`${styles.boxContainer}`}>
