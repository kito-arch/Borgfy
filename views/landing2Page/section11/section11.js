...
export default function Section11(props){
    return(
        <div className = {`${styles.container}`}>
            ...
            <p data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*3650} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.the}`}>THE WAY</p>
            <p data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*3650} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.heading}`}>We can</p>

            <div style = {{marginBottom: '398px'}} className = {`${styles.stretchBetween}`}>

                <div data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*3850} data-aos = 'fade-right' data-aos-duration = '3000' className = {`${styles.box}`}>
                ...
                <div data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*3850} data-aos = 'fade-left' data-aos-duration = '3000' className = {`${styles.box}`}>
            ...
            <div className = {`${styles.stretchBetween}`}>
                ...
                <div data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*4050} data-aos = 'fade-right' data-aos-duration = '3000' className = {`${styles.box}`}>
                ...
                <div data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*4050} data-aos = 'fade-left' data-aos-duration = '3000' className = {`${styles.box}`}>
            ...
            <Link href = 'how-to-build-and-brainstorm-ideas'>
