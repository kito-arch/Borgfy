    ...
    return(
        <div className = {`${styles.container}`}>
            <div className = {`${styles.imageContainer} hide_in_mobile`} style = {{zIndex: '1', position: 'absolute', top: '150px', right: '0'}}>
                <Image priority  className = {`${styles.image}`} src = './venture_animate.png' width = '844px' height = '496px'  layout='fixed'/>
            </div>
            <div data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*300} data-aos = 'fade-right' data-aos-duration = '3000' style = {{opacity: headingNumber == 0  ? '1' : '0'}}>
            ...
            <div className='hide_in_mobile' data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*300} data-aos = 'fade-right' data-aos-duration = '3000' style = {{opacity: headingNumber == 1  ? '1' : '0'}}>
            ...
            <div className='hide_in_mobile' data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*300} data-aos = 'fade-right' data-aos-duration = '3000' style = {{opacity: headingNumber == 2  ? '1' : '0'}}>
            ...
            <div className='show_in_mobile' data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*300} data-aos = 'fade-right' data-aos-duration = '3000' style = {{opacity: headingNumber == 1  ? '1' : '0'}}>
                <p style = {{marginTop: '50px', marginLeft: '150px'}} className = {`${styles.text}`}>LEVERAGE INNOVATION</p>
                <p style = {{marginTop: '100px'}} className = {`${styles.heading}`}>Step up your digital transformation</p>
            </div>
            <div className='show_in_mobile' data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*300} data-aos = 'fade-right' data-aos-duration = '3000' style = {{opacity: headingNumber == 2  ? '1' : '0'}}>
