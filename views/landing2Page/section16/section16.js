    ...
    return(
        <div className = {`${styles.container}`}>
            <div className = {`${styles.innerContainer}`}>
                <p data-aos-offset = "-6000" data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.heading}`}>The moust Recent articles</p>


                <div data-aos-offset = "-6000" data-aos = 'fade-left' data-aos-duration = '1000' className = {`${styles.stretchStart}`}>
