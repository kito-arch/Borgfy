    ...
    return(
        <div className = {`${styles.container}`}>
            <div className = {`${styles.innerContainer}`}>
                ...
                <div data-aos-offset = {-scroll*6000} data-aos = 'fade-left' data-aos-duration = '3000' className = {`${styles.stretchStart} hide_in_mobile`}>
                    {/* <div style = {{minWidth: '528px', marginRight: '43px', padding: '43px 63px'}} className = {`${styles.box}`}>
                        ...
                        <Image priority  src = '/../public/landing2_sec16_image1.png' width = '419px' height = '317px' />
                    </div> */}

                    <div style = {{minWidth: '414px', marginRight: '30px', padding: '124px 16px 43px'}} className = {`${styles.box}`}>
                        <Image priority  src = '/../public/landing2_sec16_mage2.png' width = '398px' height = '223px' />
                        <div>
                    ...
                    <div style = {{minWidth: '414px', marginRight: '30px', padding: '43px 16px'}} className = {`${styles.box}`}>
                        <Image priority  src = '/../public/landing2_sec16_image3.png' width = '367px' height = '367px' />
                        <div>
                            <p className = {`${styles.boxDate}`}>January 08, 2022</p>
