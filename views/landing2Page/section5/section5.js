    ...
    return(
        <div className = {`${styles.container}`}>
            ...
            <div style = {{position: 'absolute', top: '800px', left: '-12rem'}}>
                <Image priority  src = '/../public/landing2_sec5_back5.png' width = '120px' height = '170px' />
            </div>
            ...
            <div className = {`${styles.startBetween}`}>
                <div data-aos-offset = {-scroll*1200} data-aos = 'fade-up' data-aos-duration = '3000' >
                    ...
                    <div className = {`${styles.box}`}>
                        <div>
                            <Image priority  src = '/../public/landing2_sec5_image1.png' width = '261px' height = '261px' />
                        </div>
                ...
                <div data-aos-offset = {-scroll*1200} data-aos = 'fade-up' data-aos-duration = '3000' >
                    ...
                    <div style = {{marginTop: '200px'}} className = {`${styles.box}`}>
                        <div>
                            <Image priority  src = '/../public/landing2_sec5_image2.png' width = '261px' height = '261px' />
                        </div>
                ...
                <div data-aos-offset = {-scroll*1200} data-aos = 'fade-up' data-aos-duration = '3000' >
                    ...
                    <div className = {`${styles.box}`}>
                        <div style = {{paddingTop: '26px'}}>
                            <Image priority  src = '/../public/landing2_sec5_image3.png' width = '261px' height = '261px' />
                        </div>
                ...
                <div data-aos-offset = {-scroll*1200} data-aos = 'fade-up' data-aos-duration = '3000' >
                    ...
                    <div style = {{marginTop: '200px'}} className = {`${styles.box}`}>
                        <div style = {{paddingTop: '31px'}}>
                            <Image priority  src = '/../public/landing2_sec5_image4.png' width = '261px' height = '261px' />
                        </div>
