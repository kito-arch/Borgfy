...
export default function Section8(props){
    return(
        <div className = {`${styles.container}`}>
            <p data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*2800} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.heading}`}>Our Visions Crafted Into Startups</p>
            <p data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*3000} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.subheading}`}>The Venture's Build</p>

            <div className = {`${styles.centerCenter}`}>
                <div className = {`${styles.stretchBetween}`}>

                    <div data-aos-offset = {-(screen.width <= 480 ? mobscroll : myscroll)*3000} data-aos = 'fade-up' data-aos-duration = '3000' className = {`${styles.box}`}>
