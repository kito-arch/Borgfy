...
export default function Section12(props){
    return(
        <div className = {`${styles.container}`}>
            <p data-aos-offset = "-4200" data-aos = 'fade-up' data-aos-duration = '1000' className = {`${styles.heading}`}>Only the story has changed - Not the fundamentals</p>
            
            <div className = {`${styles.centerCenter}`}>
                <div className = {`${styles.stretchBetween}`}>

                    <div data-aos-offset = "-4400" data-aos = 'fade-right' data-aos-duration = '1000' className = {`${styles.box}`}>
                    ...
                    <div data-aos-offset = "-4400" data-aos = 'fade-left' data-aos-duration = '1000' className = {`${styles.box}`}>
                        <div style = {{width: 'fit-content', margin: 'auto'}}>
